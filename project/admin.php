...
<body>
    <div class="sidebar">
      ...
      <svg width="200"  viewBox="0 0 423 174" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <nav>
        ...
        <div class="profile-img">
          <img src="./product_image/Screenshot_20220111-200920.png" alt="profile img">---->
        </div>
      </nav>
      ...
      <!--  Main heading  -->
        <div class="container">
          <header>
          <h1>Welcome, Admin</h1>
          <span>Get a view of auctioneers, Bidders and Products in the system</span>
        </header>
        </div>
        ...
        <div class="cards-container">
          <div class="card card1">
            <div id="chart-1">
            <?php   
           include "editauctioneer.php";
?>

<!-- Display the results in an HTML table -->
<h2>Auctioneers</h2> <br><br>
<table>
    <thead>
        <tr>
        <th>SN</th>
    ...
    <?php 
        ...
        <tr>
          <td><?php echo $count?></td>
            ...
            <td>
                <form  method="post">
                    <button onclick="window.location.href='loginauct.php';">Edit</button><br><br>
                    <button type="submit" name="delete" value="<?php echo $row['user_id']; ?>">Delete</button>
                </form>
            </td>
        </tr>
        <?php endforeach; ?>
    ...
    <?php 
        ...
        <tr>
          <td><?php echo $count?></td>
            ...
            <td>
                <form method="post">
                    <button type="submit" name="edit" value="<?php echo $row['bidder_id']; ?>">Edit</button><br><br>
                    <button type="submit" name="delete" value="<?php echo $row['bidder_id']; ?>">Delete</button>
                </form>
            </td>
        </tr>
        <?php endforeach; ?>
...
?>
        ...
        <tr>
          <td><?php echo $count?></td>
          <td><img src="./product_image/<?php echo $row['product_image']; ?>" width="50" height="50"></td>
            <td><?php echo $row['product_name']; ?></td>
            <td><?php echo $row['product_details']; ?></td>
            <td><?php echo $row['user_id']; ?></td>
            <td><?php echo $row['min_bid_amount']; ?></td>
            <td><?php echo $row['increase_value']; ?></td>
            <td><?php echo $row['product_status']; ?></td>
            <td>
                <form method="post" >
                    <button type="submit" name="edit" value="<?php echo $row['user_id']; ?>">Edit</button><br><br>
